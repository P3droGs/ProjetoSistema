...
1.
Crie um banco de dados chamado barbearia_db.

2.
Execute o script localizado em server/src/database/init.sql para criar as tabelas e inserir os dados iniciais.
...
3.
Configure o arquivo .env na raiz da pasta server com suas credenciais do PostgreSQL:
...
2.
Como o frontend utiliza TypeScript puro, você pode abrir os arquivos .html diretamente no navegador ou utilizar uma extensão como o Live Server no VS Code para uma melhor experiência.
